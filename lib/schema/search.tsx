...
export const searchSchema = z
  .object({
    ...
    search_depth: z
      .enum(['basic', 'advanced'])
      .describe(
        'The depth of the search. Basic costs 1 credit, advanced costs 2 credits'
      ),
    include_domains: z
      .array(z.string())
      .describe(
    ...
    include_answer: z
      ...
      .describe(
        'Include an LLM-generated answer. basic/true returns quick answer, advanced returns detailed answer'
      ),
    ...
    days: z
      .number()
      .describe(
        'Number of days back from current date. Only available if topic is news. Must be > 0'
      )
      .default(3)
  })
  .strict()
...
export const searchSchemaWithDefaults = searchSchema
  .extend({
