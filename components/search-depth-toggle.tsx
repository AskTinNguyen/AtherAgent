import { type SearchDepthToggleProps } from '@/lib/types/search-toggles'
...
export function SearchDepthToggle({ enabled, currentDepth, maxDepth, onDepthChange }: SearchDepthToggleProps) {
