...
// import { ResearchState } from '@/lib/types/research'
// import { ActivityItem } from '@/lib/types/research-enhanced'
...
//   it('should sync research state', async () => {
...
//     await waitFor(() => {
//       expect(mockSupabaseClient.from).toHaveBeenCalledWith('research_states')
//     })
//   })
// }) 